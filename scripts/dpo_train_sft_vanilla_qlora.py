# DPO training on top of SFT adapter, using vanilla UltraFeedback preference data
...
app = modal.App("dpo-sft-vanilla-mistral-qlora")
...
OUTPUT_DIR = "/root/repo/outputs/dpo_sft_vanilla_mistral_instruct"
MODEL_NAME = "mistralai/Mistral-7B-Instruct-v0.2"
SFT_ADAPTER_DIR = "/root/repo/outputs/sft_model"  # SFT adapter loaded before DPO training
...
image = ( # Define modal image
    ...
    .add_local_file(
        "scripts/dpo_train_sft_vanilla_qlora.py",
        remote_path="/root/repo/scripts/dpo_train_sft_vanilla_qlora.py",
    )
)
