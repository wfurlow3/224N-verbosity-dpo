...
OUTPUT_DIR = "outputs/sft_mistral_qlora"  # Trains Mistral QLoRA and writes adapter outputs.
...
def run_training_modal(
    ...
    global OUTPUT_DIR
    OUTPUT_DIR = "/root/repo/outputs/sft_mistral_qlora"  # Write outputs to mounted volume.
